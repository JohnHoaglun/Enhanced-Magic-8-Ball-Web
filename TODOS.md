...
- [ ] Wave 2 — compose: integration, offline SW check, external-request scan, ratio gate (build)
- [ ] Release — version 0.0.0→0.0.1, docs, atomic commit + push `origin/dev` (build)
